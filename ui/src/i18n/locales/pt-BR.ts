...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.kolbick/Kolb-Bot-Beta-.json com segurança.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "No celular? Copie a URL completa (incluindo #token=...) executando kolb-bot dashboard --no-open no desktop.",
    },
    insecure: {
