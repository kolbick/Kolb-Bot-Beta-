...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.kolbick/Kolb-Bot-Beta-.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von kolb-bot dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
