...
import { Kolb-BotApp } from "./app.ts";
...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as Kolb-BotApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as Kolb-BotApp).resetToolStream();
  (state as unknown as Kolb-BotApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as Kolb-BotApp;
