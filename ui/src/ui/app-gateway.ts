...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "kolb-bot-control-ui",
    clientVersion,
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as Kolb-BotApp);
      void loadAgents(host as unknown as Kolb-BotApp);
      void loadToolsCatalog(host as unknown as Kolb-BotApp);
      void loadNodes(host as unknown as Kolb-BotApp, { quiet: true });
      void loadDevices(host as unknown as Kolb-BotApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (runId && host.refreshSessionsAfterChat.has(runId)) {
    ...
    if (state === "final") {
      void loadSessions(host as unknown as Kolb-BotApp, {
  ...
  if (hadToolEvents && state === "final") {
    void loadChatHistory(host as unknown as Kolb-BotApp);
    return true;
  }
  return false;
}
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as Kolb-BotApp, payload);
