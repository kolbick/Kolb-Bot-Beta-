      ...
      <header class="topbar">
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src=${basePath ? `${basePath}/favicon.svg` : "/favicon.svg"} alt="Kolb-Bot" />
            </div>
            <div class="brand-text">
              <div class="brand-title">KOLB-BOT</div>
        ...
        <div class="topbar-status">
          <div class="pill">
            ...
            <span class="mono">${kolbBotVersion}</span>
          </div>
          <div class="pill">
        ...
        <div class="nav-group nav-group--links">
          ...
          <div class="nav-group__items">
            <a
              ...
              href="https://docs.github.com/kolbick/Kolb-Bot-Beta-"
