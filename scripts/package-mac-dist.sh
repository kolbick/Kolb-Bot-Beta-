...
# Output:
# - dist/Kolb-Bot.app
# - dist/Kolb-Bot-<version>.zip
# - dist/Kolb-Bot-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.kolb-bot.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Kolb-Bot.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Kolb-Bot-$VERSION.zip"
DMG="$ROOT_DIR/dist/Kolb-Bot-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Kolb-Bot-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Kolb-Bot-$VERSION.dSYM.zip"
