...
export DISPLAY=:1
export HOME=/tmp/kolb-bot-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${KOLB_BOT_BROWSER_CDP_PORT:-${KOLB_BOT_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${KOLB_BOT_BROWSER_CDP_SOURCE_RANGE:-${KOLB_BOT_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${KOLB_BOT_BROWSER_VNC_PORT:-${KOLB_BOT_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${KOLB_BOT_BROWSER_NOVNC_PORT:-${KOLB_BOT_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${KOLB_BOT_BROWSER_ENABLE_NOVNC:-${KOLB_BOT_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${KOLB_BOT_BROWSER_HEADLESS:-${KOLB_BOT_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${KOLB_BOT_BROWSER_NO_SANDBOX:-${KOLB_BOT_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${KOLB_BOT_BROWSER_NOVNC_PASSWORD:-${KOLB_BOT_BROWSER_NOVNC_PASSWORD:-}}"
DISABLE_GRAPHICS_FLAGS="${KOLB_BOT_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${KOLB_BOT_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${KOLB_BOT_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
