...
if [[ -z "$version_content" ]]; then
  echo "<h2>Kolb-Bot $VERSION</h2>"
  echo "<p>Latest Kolb-Bot update.</p>"
  echo "<p><a href=\"https://github.com/kolbick/Kolb-Bot-Beta-/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
