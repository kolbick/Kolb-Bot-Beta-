...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "kolb-bot", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for Kolb-Bot. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("Kolb-Bot Issue Label Audit");
