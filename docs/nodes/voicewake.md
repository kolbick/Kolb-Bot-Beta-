...
Kolb-Bot treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.kolb-bot/settings/voicewake.json`

Shape:

```json
{ "triggers": ["kolb-bot", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
