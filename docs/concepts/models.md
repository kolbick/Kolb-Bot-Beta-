...
Kolb-Bot selects models in this order:
...
- `agents.defaults.models` is the allowlist/catalog of models Kolb-Bot can use (plus aliases).
...
kolb-bot models set <provider/model>
kolb-bot models set-image <provider/model>

kolb-bot models aliases list
kolb-bot models aliases add <alias> <provider/model>
kolb-bot models aliases remove <alias>

kolb-bot models fallbacks list
kolb-bot models fallbacks add <provider/model>
kolb-bot models fallbacks remove <provider/model>
kolb-bot models fallbacks clear

kolb-bot models image-fallbacks list
kolb-bot models image-fallbacks add <provider/model>
kolb-bot models image-fallbacks remove <provider/model>
kolb-bot models image-fallbacks clear
```

`kolb-bot models` (no subcommand) is a shortcut for `models status`.
...
`kolb-bot models scan` inspects OpenRouter’s **free model catalog** and can
...
agent directory (default `~/.kolb-bot/agents/<agentId>/models.json`). This file
...
This marker-based persistence applies whenever Kolb-Bot regenerates `models.json`, including command-driven paths like `kolb-bot agent`.
