...
Kolb-Bot formats outbound Markdown by converting it into a shared intermediate
...
```markdown
Hello **world** — see [docs](https://docs.github.com/kolbick/Kolb-Bot-Beta-).
```
...
```json
{
  ...
  "links": [{ "start": 19, "end": 23, "href": "https://docs.github.com/kolbick/Kolb-Bot-Beta-" }]
}
```
