...
read_when:
  - You are building a Kolb-Bot plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (kolb-bot.plugin.json)

Every plugin **must** ship a `kolb-bot.plugin.json` file in the **plugin root**.
Kolb-Bot uses this manifest to validate configuration **without executing plugin
