...
read_when:
  ...
  - Wiring external systems into Kolb-Bot
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your Kolb-Bot config directory (typically `~/.kolb-bot/hooks/transforms`).
...
- `kolb-bot webhooks gmail setup` writes `hooks.gmail` config for `kolb-bot webhooks gmail run`.
