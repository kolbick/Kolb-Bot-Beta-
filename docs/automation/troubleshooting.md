...
kolb-bot system heartbeat last
kolb-bot logs --follow
kolb-bot config get agents.defaults.heartbeat
kolb-bot channels status --probe
```
...
```bash
kolb-bot config get agents.defaults.heartbeat.activeHours
kolb-bot config get agents.defaults.heartbeat.activeHours.timezone
kolb-bot config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
kolb-bot cron list
kolb-bot logs --follow
```
