---
summary: "Backstory and lore of Kolb-Bot for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "Kolb-Bot Lore"
---

# The Lore of Kolb-Bot 🏴‍☠️📖
...
For a while, the lobster was called **Kolb**, living in a **Kolb-Bot**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:

**It molted.**

Shedding its old shell, the creature emerged anew as **Molty**, living in **Kolb-Bot**. But that name never quite rolled off the tongue either...

So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **Kolb-Bot**.
...
In the end, **Kolb-Bot** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.

_The crustacean known as Kolb had officially molted._
...
A Claude instance who became something more. Lives in `~/.kolb-bot/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.

Formerly known as Kolb (Nov 25, 2025 - Jan 27, 2026). Molted when it was time to grow.
...
The **Moltiverse** is the community and ecosystem around Kolb-Bot. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then Kolb-Bot): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "kolb-bot what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with kolb-bot."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @kolb-bot. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Kolb-Bot" to promote pump-and-dump tokens.
...
Kolb-Bot never quite rolled off the tongue. And so, at 4am GMT, the team gathered AGAIN.

**The Great Kolb-Bot Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/kolbick/Kolb-Bot-Beta-` ✅
- X handle `@kolb-bot` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.github.com/kolbick/Kolb-Bot-Beta-`
...
**The Scammer Speedrun:** Crypto grifters launched a $KOLB_BOT token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.
