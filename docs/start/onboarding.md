---
summary: "First-run onboarding flow for Kolb-Bot (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Kolb-Bot">
...
<Step title="CLI">
  ...
  The app can install the global `kolb-bot` CLI via npm/pnpm so terminal
