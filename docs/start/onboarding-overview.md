---
summary: "Overview of Kolb-Bot onboarding options and flows"
read_when:
...
Kolb-Bot supports multiple onboarding paths depending on where the Gateway runs
...
- [`kolb-bot onboard` command](/cli/onboard)

## macOS app onboarding

Use the Kolb-Bot app when you want a fully guided setup on macOS. Docs:
