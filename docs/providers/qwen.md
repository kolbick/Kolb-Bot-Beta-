---
summary: "Use Qwen OAuth (free tier) in Kolb-Bot"
read_when:
  - You want to use Qwen with Kolb-Bot
...
```bash
kolb-bot models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Kolb-Bot will sync credentials
