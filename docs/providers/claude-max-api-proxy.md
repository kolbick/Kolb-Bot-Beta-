...
You can point Kolb-Bot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Kolb-Bot
...
- [Anthropic provider](/providers/anthropic) - Native Kolb-Bot integration with Claude setup-token or API keys
