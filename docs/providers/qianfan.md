---
summary: "Use Qianfan's unified API to access many models in Kolb-Bot"
read_when:
...
3. Kolb-Bot installed on your system
...
4. Copy the API key for use with Kolb-Bot

## CLI setup

```bash
kolb-bot onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Kolb-Bot Configuration](/gateway/configuration)
