---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Kolb-Bot"
read_when:
  - You want Xiaomi MiMo models in Kolb-Bot
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Kolb-Bot uses
...
```bash
kolb-bot onboard --auth-choice xiaomi-api-key
# or non-interactive
kolb-bot onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
