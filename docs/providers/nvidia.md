---
summary: "Use NVIDIA's OpenAI-compatible API in Kolb-Bot"
read_when:
  - You want to use NVIDIA models in Kolb-Bot
...
kolb-bot onboard --auth-choice skip
kolb-bot models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
