...
read_when:
  - You want Kolb-Bot to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables Kolb-Bot to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`kolb-bot onboard`) and `kolb-bot channels add` list optional channel plugins.
...
```bash
kolb-bot plugins install @kolb-bot/nostr
```

Use a local checkout (dev workflows):

```bash
kolb-bot plugins install --link <path-to-kolb-bot>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "kolb-bot",
        "displayName": "Kolb-Bot",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "kolb-bot@example.com",
        "lud16": "kolb-bot@example.com"
      }
    }
  }
}
