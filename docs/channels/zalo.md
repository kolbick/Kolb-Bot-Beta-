...
- Install via CLI: `kolb-bot plugins install @kolb-bot/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `kolb-bot plugins install ./extensions/zalo`
   - From npm (if published): `kolb-bot plugins install @kolb-bot/zalo`
...
- Approve via:
  - `kolb-bot pairing list zalo`
  - `kolb-bot pairing approve zalo <CODE>`
...
- Example: `kolb-bot message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `kolb-bot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `kolb-bot logs --follow`
