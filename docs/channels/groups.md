...
Kolb-Bot treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams, Zalo.

## Beginner intro (2 minutes)

Kolb-Bot “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Kolb-Bot can see that group and respond there.
...
Translation: allowlisted senders can trigger Kolb-Bot by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@kolb-bot", "kolb-bot", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
