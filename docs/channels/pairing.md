...
read_when:
  ...
  - Reviewing Kolb-Bot security posture
title: "Pairing"
---

# Pairing

“Pairing” is Kolb-Bot’s explicit **owner approval** step.
...
Stored under `~/.kolb-bot/credentials/`:
...
3. On your phone, open the Kolb-Bot iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `kolb-bot nodes pending/approve`) is a
