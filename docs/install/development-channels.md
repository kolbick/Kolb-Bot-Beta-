...
Kolb-Bot ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Kolb-Bot also aligns
the install method:
...
When you switch channels with `kolb-bot update`, Kolb-Bot also syncs plugin sources:
