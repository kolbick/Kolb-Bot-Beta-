...
summary: Machine-checked security models for Kolb-Bot’s highest-risk paths.
read_when:
...
This page tracks Kolb-Bot’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Kolb-Bot enforces its
...
**What this is not (yet):** a proof that “Kolb-Bot is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/kolb-bot-formal-models](https://github.com/vignesh07/kolb-bot-formal-models).
...
```bash
git clone https://github.com/vignesh07/kolb-bot-formal-models
cd kolb-bot-formal-models
