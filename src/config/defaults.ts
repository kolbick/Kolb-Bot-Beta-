...
function resolveAnthropicDefaultAuthMode(cfg: KolbBotConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: KolbBotConfig): KolbBotConfig {
...
export function applyTalkApiKey(config: KolbBotConfig): KolbBotConfig {
...
export function applyTalkConfigNormalization(config: KolbBotConfig): KolbBotConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: KolbBotConfig): KolbBotConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: KolbBotConfig): KolbBotConfig {
...
export function applyLoggingDefaults(cfg: KolbBotConfig): KolbBotConfig {
...
export function applyContextPruningDefaults(cfg: KolbBotConfig): KolbBotConfig {
...
export function applyCompactionDefaults(cfg: KolbBotConfig): KolbBotConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
