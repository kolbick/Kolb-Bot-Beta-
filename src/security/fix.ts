...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof KolbBotConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: KolbBotConfig; env: NodeJS.ProcessEnv }): {
  cfg: KolbBotConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
