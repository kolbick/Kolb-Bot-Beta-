...
describe("resolveTaskScriptPath", () => {
  it.each([
    {
      name: "uses default path when KOLB_BOT_PROFILE is unset",
      env: { USERPROFILE: "C:\\Users\\test" },
      expected: path.join("C:\\Users\\test", ".kolb-bot", "gateway.cmd"),
    },
    {
      name: "uses profile-specific path when KOLB_BOT_PROFILE is set to a custom value",
      env: { USERPROFILE: "C:\\Users\\test", KOLB_BOT_PROFILE: "jbphoenix" },
      expected: path.join("C:\\Users\\test", ".kolb-bot-jbphoenix", "gateway.cmd"),
    },
    {
      name: "prefers KOLB_BOT_STATE_DIR over profile-derived defaults",
      env: {
        USERPROFILE: "C:\\Users\\test",
        KOLB_BOT_PROFILE: "rescue",
        KOLB_BOT_STATE_DIR: "C:\\State\\kolb-bot",
      },
      expected: path.join("C:\\State\\kolb-bot", "gateway.cmd"),
    },
    {
      name: "falls back to HOME when USERPROFILE is not set",
      env: { HOME: "/home/test", KOLB_BOT_PROFILE: "default" },
      expected: path.join("/home/test", ".kolb-bot", "gateway.cmd"),
    },
  ])("$name", ({ env, expected }) => {
...
describe("readScheduledTaskCommand", () => {
    ...
    await withScheduledTaskScript(
      {
        scriptLines: [
          "@echo off",
          '"C:\\Program Files\\nodejs\\node.exe" C:\\Users\\test\\AppData\\Roaming\\npm\\node_modules\\kolb-bot\\dist\\index.js gateway --port 18789',
        ],
      },
      async (env) => {
        const result = await readScheduledTaskCommand(env);
        expect(result).toEqual({
          programArguments: [
            "C:\\Program Files\\nodejs\\node.exe",
            "C:\\Users\\test\\AppData\\Roaming\\npm\\node_modules\\kolb-bot\\dist\\index.js",
            "gateway",
            "--port",
            "18789",
          ],
    ...
    await withScheduledTaskScript(
      {
        scriptLines: [
          "@echo off",
          '"\\\\fileserver\\Kolb-Bot Share\\node.exe" "\\\\fileserver\\Kolb-Bot Share\\dist\\index.js" gateway --port 18789',
        ],
      },
      async (env) => {
        const result = await readScheduledTaskCommand(env);
        expect(result).toEqual({
          programArguments: [
            "\\\\fileserver\\Kolb-Bot Share\\node.exe",
            "\\\\fileserver\\Kolb-Bot Share\\dist\\index.js",
            "gateway",
            "--port",
            "18789",
          ],
  ...
  it("reads script from KOLB_BOT_STATE_DIR override", async () => {
    await withScheduledTaskScript(
      {
        env: (tmpDir) => ({ KOLB_BOT_STATE_DIR: path.join(tmpDir, "custom-state") }),
