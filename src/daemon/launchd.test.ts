...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.kolb-bot.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", KOLB_BOT_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("enables, bootstraps, and kickstarts the resolved label", async () => {
    ...
    const label = "ai.kolb-bot.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.github.com/kolbick/Kolb-Bot-Beta-/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when KOLB_BOT_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.kolb-bot.gateway.plist",
    },
    {
      name: "uses profile-specific label when KOLB_BOT_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", KOLB_BOT_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.kolb-bot.jbphoenix.plist",
    },
    {
      name: "prefers KOLB_BOT_LAUNCHD_LABEL over KOLB_BOT_PROFILE",
      env: {
        HOME: "/Users/test",
        KOLB_BOT_PROFILE: "jbphoenix",
        KOLB_BOT_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from KOLB_BOT_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        KOLB_BOT_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty KOLB_BOT_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        KOLB_BOT_PROFILE: "myprofile",
        KOLB_BOT_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.kolb-bot.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
