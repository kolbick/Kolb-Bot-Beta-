    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["kolb-bot directory self --channel slack", "Show the connected account identity."],
          [
            'kolb-bot directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["kolb-bot directory groups list --channel discord", "List available groups/channels."],
          [
            "kolb-bot directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.github.com/kolbick/Kolb-Bot-Beta-/cli/directory",
        )}\n`,
    )
    .action(() => {
