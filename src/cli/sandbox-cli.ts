...
const SANDBOX_EXAMPLES = {
  main: [
    ["kolb-bot sandbox list", "List all sandbox containers."],
    ["kolb-bot sandbox list --browser", "List only browser containers."],
    ["kolb-bot sandbox recreate --all", "Recreate all containers."],
    ["kolb-bot sandbox recreate --session main", "Recreate a specific session."],
    ["kolb-bot sandbox recreate --agent mybot", "Recreate agent containers."],
    ["kolb-bot sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["kolb-bot sandbox list", "List all sandbox containers."],
    ["kolb-bot sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["kolb-bot sandbox recreate --all", "Recreate all containers."],
    ["kolb-bot sandbox recreate --session main", "Recreate a specific session."],
    ["kolb-bot sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["kolb-bot sandbox recreate --browser --all", "Recreate only browser containers."],
    ["kolb-bot sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["kolb-bot sandbox explain", "Show effective sandbox config."],
    ["kolb-bot sandbox explain --session agent:main:main", "Explain a specific session."],
    ["kolb-bot sandbox explain --agent work", "Explain an agent sandbox."],
    ["kolb-bot sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.github.com/kolbick/Kolb-Bot-Beta-/cli/sandbox")}\n`,
    )
    .action(() => {
