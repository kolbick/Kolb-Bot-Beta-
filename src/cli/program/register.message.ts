...
${formatHelpExamples([
  ['kolb-bot message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'kolb-bot message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'kolb-bot message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.github.com/kolbick/Kolb-Bot-Beta-/cli/message")}`,
    )
    .action(() => {
