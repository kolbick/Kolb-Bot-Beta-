...
export function registerOnboardCommand(program: Command) {
  const command = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/onboard", "docs.github.com/kolbick/Kolb-Bot-Beta-/cli/onboard")}\n`,
    )
  ...
  command
    ...
    .option(
      ...
      "Gateway token SecretRef env var name (token auth; e.g. KOLB_BOT_GATEWAY_TOKEN)",
    )
