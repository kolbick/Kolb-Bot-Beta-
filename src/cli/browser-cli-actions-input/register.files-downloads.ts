...
export function registerBrowserFilesAndDownloadsCommands(
  ...
  browser
    ...
    .argument(
      "<paths...>",
      "File paths to upload (must be within Kolb-Bot temp uploads dir, e.g. /tmp/kolb-bot/uploads/file.pdf)",
    )
  ...
  browser
    ...
    .argument(
      "[path]",
      "Save path within kolb-bot temp downloads dir (default: /tmp/kolb-bot/downloads/...; fallback: os.tmpdir()/kolb-bot/downloads/...)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",
  ...
  browser
    ...
    .argument(
      "<path>",
      "Save path within kolb-bot temp downloads dir (e.g. report.pdf or /tmp/kolb-bot/downloads/report.pdf)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",
