      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["kolb-bot gateway run", "Run the gateway in the foreground."],
            ["kolb-bot gateway status", "Show service status and probe reachability."],
            ["kolb-bot gateway discover", "Find local and wide-area gateway beacons."],
            ["kolb-bot gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.github.com/kolbick/Kolb-Bot-Beta-/cli/gateway")}\n`,
      ),
  );
