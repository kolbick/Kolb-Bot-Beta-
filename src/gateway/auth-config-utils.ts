import type { GatewayAuthConfig, KolbBotConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: KolbBotConfig, password: string): KolbBotConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
