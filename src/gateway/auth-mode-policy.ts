...
export function hasAmbiguousGatewayAuthModeConfig(cfg: KolbBotConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: KolbBotConfig): void {
