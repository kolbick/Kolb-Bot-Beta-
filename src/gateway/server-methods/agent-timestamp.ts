 ...
 *
 * @see https://github.com/kolb-bot/kolb-bot/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an KolbBotConfig.
 */
export function timestampOptsFromConfig(cfg: KolbBotConfig): TimestampInjectionOptions {
  return {
