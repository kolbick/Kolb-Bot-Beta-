...
function listConfiguredAgentIds(cfg: KolbBotConfig): string[] {
...
export function listAgentsForGateway(cfg: KolbBotConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: KolbBotConfig): string {
...
function resolveSessionStoreAgentId(cfg: KolbBotConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: KolbBotConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: KolbBotConfig): GatewaySessionsDefaults {
