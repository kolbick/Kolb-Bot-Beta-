...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.KOLB_BOT_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: KolbBotConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: KolbBotConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/kolbick/Kolb-Bot-Beta-/issues/30673
...
export function listEnabledTelegramAccounts(cfg: KolbBotConfig): ResolvedTelegramAccount[] {
