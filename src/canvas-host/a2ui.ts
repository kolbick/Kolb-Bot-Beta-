...
export const A2UI_PATH = "/__kolb-bot__/a2ui";

export const CANVAS_HOST_PATH = "/__kolb-bot__/canvas";

export const CANVAS_WS_PATH = "/__kolb-bot__/ws";
...
(() => {
  ...
  globalThis.Kolb-Bot = globalThis.Kolb-Bot ?? {};
  globalThis.Kolb-Bot.postMessage = postToNode;
  globalThis.Kolb-Bot.sendUserAction = sendUserAction;
