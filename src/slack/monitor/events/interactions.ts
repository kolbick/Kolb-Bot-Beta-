...
// Prefix for Kolb-Bot-generated action IDs to scope our handler
const KOLB_BOT_ACTION_PREFIX = "kolb-bot:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${KOLB_BOT_ACTION_PREFIX}`);

  // Handle Kolb-Bot modal submissions with callback_ids scoped by our prefix.
  registerModalLifecycleHandler({
