...
export function mergeSlackAccountConfig(cfg: KolbBotConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: KolbBotConfig): ResolvedSlackAccount[] {
