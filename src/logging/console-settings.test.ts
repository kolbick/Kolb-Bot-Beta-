...
let originalKolbBotTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalKolbBotTestConsole = process.env.KOLB_BOT_TEST_CONSOLE;
  process.env.KOLB_BOT_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalKolbBotTestConsole === undefined) {
    delete process.env.KOLB_BOT_TEST_CONSOLE;
  } else {
    process.env.KOLB_BOT_TEST_CONSOLE = originalKolbBotTestConsole;
  }
