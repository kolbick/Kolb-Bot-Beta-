...
export function listWhatsAppAuthDirs(cfg: KolbBotConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: KolbBotConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: KolbBotConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: KolbBotConfig): ResolvedWhatsAppAccount[] {
