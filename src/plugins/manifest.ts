...
export const PLUGIN_MANIFEST_FILENAME = "kolb-bot.plugin.json";
...
// package.json "kolb-bot" metadata (used for onboarding/catalog)
...
export type KolbBotPackageManifest = {
  extensions?: string[];
...
): KolbBotPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
