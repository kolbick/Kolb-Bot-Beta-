...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/kolb-bot/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/kolb-bot/extensions",
        global: "/Users/x/.kolb-bot/extensions",
        workspace: "/Users/x/ws/.kolb-bot/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.kolb-bot/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/kolb-bot/extensions",
        global: "/Users/x/.kolb-bot/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.kolb-bot/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/kolb-bot/extensions",
        global: "/Users/x/.kolb-bot/extensions",
