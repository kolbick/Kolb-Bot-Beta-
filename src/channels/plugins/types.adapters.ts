...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: KolbBotConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: KolbBotConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: KolbBotConfig) => string;
  setAccountEnabled?: (params: {
    cfg: KolbBotConfig;
    accountId: string;
    enabled: boolean;
  }) => KolbBotConfig;
  deleteAccount?: (params: { cfg: KolbBotConfig; accountId: string }) => KolbBotConfig;
  isEnabled?: (account: ResolvedAccount, cfg: KolbBotConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: KolbBotConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: KolbBotConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: KolbBotConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: KolbBotConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.github.com/kolbick/Kolb-Bot-Beta-/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: KolbBotConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
