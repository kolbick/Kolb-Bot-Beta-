...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: KolbBotConfig): string | undefined {
  ...
  function listAccountIds(cfg: KolbBotConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: KolbBotConfig): string {
