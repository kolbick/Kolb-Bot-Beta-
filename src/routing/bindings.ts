...
export function listBindings(cfg: KolbBotConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: KolbBotConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: KolbBotConfig) {
