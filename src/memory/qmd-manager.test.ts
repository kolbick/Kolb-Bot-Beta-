...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: KolbBotConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: KolbBotConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__kolbBotMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__kolbBotMcporterColdStartWarned;
  });
