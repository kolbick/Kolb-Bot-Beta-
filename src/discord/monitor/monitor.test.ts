...
describe("agent components", () => {
  const createCfg = (): KolbBotConfig => ({}) as KolbBotConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/kolb-bot-sessions-test.json");
  });
