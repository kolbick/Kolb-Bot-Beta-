...
export function isAcpEnabledByPolicy(cfg: KolbBotConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: KolbBotConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: KolbBotConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: KolbBotConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: KolbBotConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: KolbBotConfig, agentId: string): boolean {
