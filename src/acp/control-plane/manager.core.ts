...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: KolbBotConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: KolbBotConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: KolbBotConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: KolbBotConfig }): Promise<void> {
