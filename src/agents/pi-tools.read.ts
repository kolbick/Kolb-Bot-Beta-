...
function resolveAdaptiveReadMaxBytes(options?: KolbBotReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createKolbBotReadTool(base, {
...
export function createKolbBotReadTool(
  base: AnyAgentTool,
  options?: KolbBotReadToolOptions,
): AnyAgentTool {
