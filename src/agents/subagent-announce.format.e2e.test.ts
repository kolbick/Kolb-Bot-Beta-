...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/kolbick/Kolb-Bot-Beta-/issues/31298
    previousFastTestEnv = process.env.KOLB_BOT_TEST_FAST;
  ...
  beforeEach(() => {
    // KOLB_BOT_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("Kolb-Bot runtime context (internal):");
