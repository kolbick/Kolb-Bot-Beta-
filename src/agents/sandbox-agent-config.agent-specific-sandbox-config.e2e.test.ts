...
async function resolveContext(config: KolbBotConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): KolbBotConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
