...
describe("gateway tool defaults", () => {
  ...
  it("uses KOLB_BOT_GATEWAY_TOKEN for allowlisted local overrides", () => {
  ...
  it("does not leak local env/config tokens to remote overrides", () => {
    process.env.KOLB_BOT_GATEWAY_TOKEN = "local-env-token";
    process.env.KOLB_BOT_GATEWAY_TOKEN = "legacy-env-token";
    configState.value = {
      gateway: {
