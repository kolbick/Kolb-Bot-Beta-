...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): KolbBotConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: KolbBotConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: KolbBotConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
