...
function asKolbBotConfig(config: Partial<KolbBotConfig>): KolbBotConfig {
  return config as KolbBotConfig;
}

function createToolConfig() {
  return asKolbBotConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: KolbBotConfig = createToolConfig()) {
