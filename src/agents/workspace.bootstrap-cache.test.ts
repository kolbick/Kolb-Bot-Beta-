...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("kolb-bot-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("kolb-bot-cache-test1-");
    const workspace2 = await makeTempWorkspace("kolb-bot-cache-test2-");
