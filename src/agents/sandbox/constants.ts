...
export const DEFAULT_SANDBOX_IMAGE = "kolb-bot-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "kolb-bot-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "kolb-bot-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "kolb-bot-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "kolb-bot-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "kolb-bot-sandbox-browser";
