import type { KolbBotConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveIdentityNamePrefix(cfg: KolbBotConfig, agentId: string): string | undefined {
...
export function resolveIdentityName(cfg: KolbBotConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[kolb-bot]";
}
