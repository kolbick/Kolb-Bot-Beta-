...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveKolbBotAgentDir() returns mainAgentDir
    process.env.KOLB_BOT_STATE_DIR = tmpDir;
    process.env.KOLB_BOT_AGENT_DIR = mainAgentDir;
