...
function resolveAvatarSource(cfg: KolbBotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: KolbBotConfig, agentId: string): AgentAvatarResolution {
