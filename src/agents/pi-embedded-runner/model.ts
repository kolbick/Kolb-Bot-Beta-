...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveKolbBotAgentDir();
 ...
 * a hint.
 *
 * See: https://github.com/kolbick/Kolb-Bot-Beta-/issues/17328
 */
const LOCAL_PROVIDER_HINTS: Record<string, string> = {
  ollama:
    "Ollama requires authentication to be registered as a provider. " +
    'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "kolb-bot configure". ' +
    "See: https://docs.github.com/kolbick/Kolb-Bot-Beta-/providers/ollama",
  vllm:
    "vLLM requires authentication to be registered as a provider. " +
    'Set VLLM_API_KEY (any value works) or run "kolb-bot configure". ' +
    "See: https://docs.github.com/kolbick/Kolb-Bot-Beta-/providers/vllm",
};
