...
function resolveWatchPaths(workspaceDir: string, config?: KolbBotConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: KolbBotConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: KolbBotConfig }) {
