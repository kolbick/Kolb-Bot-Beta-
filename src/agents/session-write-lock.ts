...
const CLEANUP_STATE_KEY = Symbol.for("kolb-bot.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("kolb-bot.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("kolb-bot.sessionWriteLockWatchdogState");
