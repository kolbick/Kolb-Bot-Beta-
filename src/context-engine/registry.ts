...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("kolb-bot.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: KolbBotConfig): Promise<ContextEngine> {
