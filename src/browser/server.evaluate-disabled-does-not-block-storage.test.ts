...
describe("browser control evaluate gating", () => {
  beforeEach(async () => {
    ...
    prevGatewayPort = process.env.KOLB_BOT_GATEWAY_PORT;
    process.env.KOLB_BOT_GATEWAY_PORT = String(testPort - 2);
    prevGatewayToken = process.env.KOLB_BOT_GATEWAY_TOKEN;
    prevGatewayPassword = process.env.KOLB_BOT_GATEWAY_PASSWORD;
