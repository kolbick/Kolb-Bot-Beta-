...
export function applyOpenrouterProviderConfig(cfg: KolbBotConfig): KolbBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: KolbBotConfig): KolbBotConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: KolbBotConfig): KolbBotConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: KolbBotConfig): KolbBotConfig {
...
export function applyMoonshotConfig(cfg: KolbBotConfig): KolbBotConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: KolbBotConfig): KolbBotConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: KolbBotConfig): KolbBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: KolbBotConfig): KolbBotConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: KolbBotConfig): KolbBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: KolbBotConfig): KolbBotConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: KolbBotConfig): KolbBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: KolbBotConfig): KolbBotConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: KolbBotConfig): KolbBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: KolbBotConfig): KolbBotConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: KolbBotConfig): KolbBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: KolbBotConfig): KolbBotConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: KolbBotConfig): KolbBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: KolbBotConfig): KolbBotConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: KolbBotConfig): KolbBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: KolbBotConfig): KolbBotConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: KolbBotConfig): KolbBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: KolbBotConfig): KolbBotConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: KolbBotConfig): KolbBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: KolbBotConfig): KolbBotConfig {
...
export function applyQianfanProviderConfig(cfg: KolbBotConfig): KolbBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: KolbBotConfig): KolbBotConfig {
