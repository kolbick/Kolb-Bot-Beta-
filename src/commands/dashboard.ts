...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set KOLB_BOT_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `kolb-bot dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Kolb-Bot.");
  } else if (hint) {
    runtime.log(hint);
  }
}
