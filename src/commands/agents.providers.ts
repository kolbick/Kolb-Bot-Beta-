...
function resolveDefaultAccountId(cfg: KolbBotConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: KolbBotConfig): boolean {
...
export function summarizeBindings(cfg: KolbBotConfig, bindings: AgentBinding[]): string[] {
