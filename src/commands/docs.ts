...
const SEARCH_TOOL = "https://docs.github.com/kolbick/Kolb-Bot-Beta-/mcp.SearchKolbBot";
...
export async function docsSearchCommand(queryParts: string[], runtime: RuntimeEnv) {
  ...
  if (!query) {
    const docs = formatDocsLink("/", "docs.github.com/kolbick/Kolb-Bot-Beta-");
    if (isRich()) {
      runtime.log(`${theme.muted("Docs:")} ${docs}`);
      runtime.log(`${theme.muted("Search:")} ${formatCliCommand('kolb-bot docs "your query"')}`);
    } else {
      runtime.log("Docs: https://docs.github.com/kolbick/Kolb-Bot-Beta-/");
