...
export function applyVercelAiGatewayProviderConfig(cfg: KolbBotConfig): KolbBotConfig {
...
export function applyVercelAiGatewayConfig(cfg: KolbBotConfig): KolbBotConfig {
