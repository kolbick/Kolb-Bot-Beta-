...
export function summarizeExistingConfig(config: KolbBotConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.github.com/kolbick/Kolb-Bot-Beta-/gateway/remote",
    "https://docs.github.com/kolbick/Kolb-Bot-Beta-/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
