...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@kolb-bot", { botUsername: "kolb-bot" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@kolb-bot args", {
        botUsername: "kolb-bot",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@kolb-bot: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "kolb-bot" })).toBe(
      "/help@otherbot",
    );
  });
