...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bkolb-bot\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: {
          identityName: "Kolb-Bot",
          provider: "anthropic",
          model: "claude-opus-4-5",
          thinkingLevel: "high",
        },
        expected: "[Kolb-Bot] anthropic/claude-opus-4-5 (think:high)",
      },
    ] as const;
