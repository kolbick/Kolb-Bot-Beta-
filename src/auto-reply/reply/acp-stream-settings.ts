...
function resolveAcpStreamCoalesceIdleMs(cfg: KolbBotConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: KolbBotConfig): number {
...
export function resolveAcpProjectionSettings(cfg: KolbBotConfig): AcpProjectionSettings {
