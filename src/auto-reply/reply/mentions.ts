...
function resolveMentionPatterns(cfg: KolbBotConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: KolbBotConfig | undefined, agentId?: string): RegExp[] {
