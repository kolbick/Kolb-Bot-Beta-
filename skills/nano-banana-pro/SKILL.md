...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.kolbick/Kolb-Bot-Beta-.json`
...
- The script prints a `MEDIA:` line for Kolb-Bot to auto-attach on supported chat providers.
