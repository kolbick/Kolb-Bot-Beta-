import type { KolbBotConfig, KolbBotPluginApi } from "kolb-bot/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: KolbBotConfig): { id: string; name: string } {
