import type {
  ...
  PluginLogger,
} from "kolb-bot/plugin-sdk/acpx";
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "kolb-bot/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: KolbBotPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: KolbBotPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
