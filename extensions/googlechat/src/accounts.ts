...
import { isSecretRef } from "kolb-bot/plugin-sdk/googlechat";
import { createAccountListHelpers, type KolbBotConfig } from "kolb-bot/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: KolbBotConfig): ResolvedGoogleChatAccount[] {
