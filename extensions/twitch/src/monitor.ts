...
import type { ReplyPayload, KolbBotConfig } from "kolb-bot/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "kolb-bot/plugin-sdk/twitch";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as KolbBotConfig;
