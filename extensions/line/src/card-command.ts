import type { LineChannelData, KolbBotPluginApi, ReplyPayload } from "kolb-bot/plugin-sdk/line";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: KolbBotPluginApi): void {
  api.registerCommand({
    name: "card",
