import type { KolbBotConfig, PluginRuntime, ResolvedLineAccount } from "kolb-bot/plugin-sdk/line";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: KolbBotConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: KolbBotConfig; accountId: string }): Promise<{
