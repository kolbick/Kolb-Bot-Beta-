...
import { createAccountListHelpers, type KolbBotConfig } from "kolb-bot/plugin-sdk/zalo";
...
function mergeZaloAccountConfig(cfg: KolbBotConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: KolbBotConfig): ResolvedZaloAccount[] {
