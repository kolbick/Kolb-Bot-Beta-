...
} from "kolb-bot/plugin-sdk/account-id";
import type { KolbBotConfig } from "kolb-bot/plugin-sdk/nostr";
...
function resolveConfiguredDefaultNostrAccountId(cfg: KolbBotConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: KolbBotConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: KolbBotConfig): string {
