import { createScopedChannelConfigBase } from "kolb-bot/plugin-sdk/compat";
import {
...
} from "kolb-bot/plugin-sdk/discord";
...
export const discordPlugin: ChannelPlugin<ResolvedDiscordAccount> = {
  ...
  agentPrompt: {
    messageToolHints: () => [
      ...
      "- Forms: add `components.modal` (title, fields). Kolb-Bot adds a trigger button and routes submissions as new messages.",
    ],
  },
  messaging: {
