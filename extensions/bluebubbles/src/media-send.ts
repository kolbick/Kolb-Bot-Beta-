...
import { resolveChannelMediaMaxBytes, type KolbBotConfig } from "kolb-bot/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: KolbBotConfig; accountId?: string }): string[] {
