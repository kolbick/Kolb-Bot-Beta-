...
import { createAccountListHelpers, type KolbBotConfig } from "kolb-bot/plugin-sdk/bluebubbles";
...
export function listEnabledBlueBubblesAccounts(cfg: KolbBotConfig): ResolvedBlueBubblesAccount[] {
