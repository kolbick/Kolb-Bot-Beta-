import type { KolbBotConfig } from "kolb-bot/plugin-sdk/bluebubbles";
...
function resolveBlueBubblesDebounceMs(config: KolbBotConfig, core: BlueBubblesCoreRuntime): number {
