...
This directory contains the **BlueBubbles external channel plugin** for Kolb-Bot.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `kolb-bot/plugin-sdk` helpers.
