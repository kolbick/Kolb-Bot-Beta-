import type {
  ...
  WizardPrompter,
  MSTeamsTeamConfig,
} from "kolb-bot/plugin-sdk/msteams";
import {
  DEFAULT_ACCOUNT_ID,
  formatDocsLink,
...
function setMSTeamsDmPolicy(cfg: KolbBotConfig, dmPolicy: DmPolicy) {
...
function setMSTeamsAllowFrom(cfg: KolbBotConfig, allowFrom: string[]): KolbBotConfig {
