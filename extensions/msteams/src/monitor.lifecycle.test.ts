...
import type { KolbBotConfig, RuntimeEnv } from "kolb-bot/plugin-sdk/msteams";
...
vi.mock("kolb-bot/plugin-sdk/msteams", () => ({
...
function createConfig(port: number): KolbBotConfig {
  return {
    channels: {
      msteams: {
        enabled: true,
