...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "kolb-bot/plugin-sdk/msteams";
...
import { resolvePreferredKolbBotTmpDir } from "../../../src/infra/tmp-kolb-bot-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredKolbBotTmpDir(), "msteams-mention-"));
