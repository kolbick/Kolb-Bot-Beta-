...
import { createAccountListHelpers, type KolbBotConfig } from "kolb-bot/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: KolbBotConfig): ResolvedMattermostAccount[] {
