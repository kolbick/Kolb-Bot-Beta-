...
import type { KolbBotPluginApi } from "kolb-bot/plugin-sdk/mattermost";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("kolb-bot/plugin-sdk/mattermost").KolbBotConfig;
    runtime: import("kolb-bot/plugin-sdk/mattermost").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
 ...
 */
export function registerSlashCommandRoute(api: KolbBotPluginApi) {
