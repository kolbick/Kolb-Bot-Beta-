...
import { createAccountListHelpers, type KolbBotConfig } from "kolb-bot/plugin-sdk/zalouser";
...
function mergeZalouserAccountConfig(cfg: KolbBotConfig, accountId: string): ZalouserAccountConfig {
