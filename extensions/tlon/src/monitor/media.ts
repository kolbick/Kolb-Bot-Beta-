...
import { fetchWithSsrFGuard } from "kolb-bot/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to Kolb-Bot workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".kolb-bot", "workspace", "media", "inbound");
 ...
 * Format matches Kolb-Bot's expected attachment structure.
 */
